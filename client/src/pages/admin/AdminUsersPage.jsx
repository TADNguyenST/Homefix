import { Table, Tag, Button, Typography, Space, message, Modal, Input, Select, Card, Tooltip } from 'antd';
          ...
          {record.role !== 'ADMIN' && (
            <Tooltip title={record.is_active ? 'Khóa tài khoản' : 'Mở khóa tài khoản'}>
              <Button
                ...
                aria-label={record.is_active ? 'Khóa tài khoản' : 'Mở khóa tài khoản'}
